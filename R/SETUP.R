...
#     }
#
# R.biBars <- function(x, g, lbl = c("No", "Yes"), grid = TRUE, clr = c("#7a8998", "#74006f")) { ## x = a dataframe or matrix; g = the grouping variable (supplied as either the column name or the appropriate column's numeric index value (e.g., '`g = "ColA"`' or '`g = 1`')); lbl = group labels ##
	# ## multi-plot setup ##
